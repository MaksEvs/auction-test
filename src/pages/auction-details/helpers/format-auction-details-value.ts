...
export function formatAuctionDetailsValue(
  value: TMaybe<string | number>,
): string {
  return formatDisplayValue(value, AUCTION_DETAILS_EMPTY_VALUE)
}

export function formatAuctionDetailsDateTime(
  value: TMaybe<string>,
): string {
  return formatDateTime(value, AUCTION_DETAILS_EMPTY_VALUE)
}

export function formatAuctionDetailsNumber(
  value: TMaybe<number>,
  options?: Intl.NumberFormatOptions,
): string {
  return formatNumber(value, options, AUCTION_DETAILS_EMPTY_VALUE)
}

export function formatAuctionDetailsMoney(
  value: TMaybe<number>,
  currencyCode: string,
): string {
